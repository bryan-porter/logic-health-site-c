...
| Dimension              | Chronic Care Management (CCM)                                                                 | Remote Physiologic Monitoring (RPM)                                                   |
|------------------------|-----------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Core criterion         | ≥ 2 chronic conditions expected to last ≥ 12 months and pose significant risk               | Ongoing collection of physiologic data via connected device(s); no minimum # of conditions |
| Consent requirement    | Verbal consent documented in the record                                                      | Written or electronic consent with higher threshold than CCM                           |
| Typical enrollee share | ~60–70% of Medicare population meets chronic-condition threshold                             | Smaller pool; many overlap with CCM cohort, enabling dual billing when rules are met   |
...
Recent CMS claims data illustrate how rapidly RPM is being adopted in skilled nursing visits:
